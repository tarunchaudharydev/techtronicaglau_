...
import { aboutGizmo } from "../data/home-data";
...
function Gizmo() {
  ...
  <li>• Hands-on building sessions with guidance from seniors and mentors.</li>
  <li>• Tracks covering robotics basics, electronics, and embedded systems.</li>
  <li>• A friendly, experimental space to ask doubts, test ideas, and learn by doing.</li>
</ul>
...
<p className="text-orange-500 font-medium text-right">
  ...
  experimentation, the club helps you turn concepts into working robots and
  ...
  <div className="text-center space-y-2">
    ...
    <p className="text-sm sm:text-base text-slate-800 max-w-3xl mx-auto">
      ...
      multiple tracks and grow as they build and experiment.
    </p>
  </div>
  ...
  <div className="grid gap-6 md:grid-cols-3 text-xs sm:text-sm">
    <div className="rounded-3xl border border-sky-200 bg-sky-50 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Introduction to motors, sensors, controllers, and simple robot builds—
        ideal for beginners starting with hardware.
      </p>
    </div>
    ...
    <div className="rounded-3xl border border-amber-200 bg-amber-50 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Team-based projects focused on automation, smart systems, and practical
        robotic solutions that solve real problems.
      </p>
    </div>
  </div>
</section>
  ...
  <div className="grid gap-8 lg:grid-cols-2 items-start">
    ...
    <div className="space-y-4">
      ...
      <ul className="text-sm sm:text-base text-slate-800 space-y-2.5 list-disc pl-6">
        <li>Build and experiment with robots, circuits, and electronic components.</li>
        <li>
          Work hands-on with motors, sensors, microcontrollers, and embedded systems.
        </li>
        <li>
          Collaborate on team-based hardware projects and automation ideas.
        </li>
        <li>
          Test, debug, and improve hardware designs through trial and experimentation.
        </li>
        <li>
          Learn practical electronics concepts by turning theory into real builds.
        </li>
      </ul>
    </div>
    ...
    <div className="rounded-3xl bg-sky-50/80 border border-orange-100 px-6 sm:px-7 py-6 sm:py-7 space-y-5 shadow-sm">
      ...
      <p className="text-sm text-slate-700">
        Gizmo is for students who are curious about robotics, electronics, and
        building real hardware systems through hands-on learning.
      </p>
      ...
      <div className="grid gap-4 md:grid-cols-2 text-sm">
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            New to robotics or electronics and looking for structured guidance
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            Interested in motors, sensors, circuits, and embedded systems and
            want to build working models.
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            Want to turn ideas into robots, automation systems, or electronic
            prototypes with a collaborative team.
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            Enjoy experimenting, testing, and learning by building rather than
      ...
      <p className="text-xs sm:text-sm text-slate-600 border-t border-slate-200 pt-4">
        <span className="font-semibold text-slate-800">No prior experience required.</span>{" "}
        All you need is curiosity, patience, and a willingness to learn through
  ...
  <div className="grid gap-4 sm:grid-cols-2 text-xs sm:text-sm">
    <div className="rounded-2xl bg-white border border-sky-100 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Sessions start with assembling circuits, sensors, or mechanical parts,
        so you learn by physically building and testing components.
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-purple-100 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Seniors demonstrate tools, wiring, and modules step-by-step before you
        try the same setup on your own kits.
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-emerald-100 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Small challenges like line-following bots, sensor automation, or motor
        control tasks to apply concepts immediately.
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-white border border-amber-100 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Work in small groups where mentors help debug circuits, fix hardware
        issues, and improve design thinking.
      </p>
    </div>
  </div>
</div>
