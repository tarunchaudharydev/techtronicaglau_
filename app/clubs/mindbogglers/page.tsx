            ...
            <div className="space-y-5">
              <div className="space-y-3 text-center lg:text-left">
                ...
                <p className="text-sm text-slate-700">
                  With a mix of interactive quizzes, creative challenges, guided
                  discussions, and self-practice, the club helps you sharpen
                  your thinking, express ideas clearly, and build confidence in
                  communication.
                </p>
              </div>
          ...
          <section className="space-y-5">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-sm sm:text-base text-slate-800 max-w-3xl mx-auto">
                ...
                communication. Members are free to switch tracks as they
            ...
            <div className="grid gap-6 md:grid-cols-3 text-sm">
              ...
              <div className="rounded-3xl border border-sky-200 bg-sky-50 px-5 py-5 shadow-sm">
                ...
                <p className="text-slate-800">
                  General knowledge, current affairs, logical reasoning, and
                  themed quizzes designed to build awareness, speed, and
                  confidence.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-purple-200 bg-purple-50 px-5 py-5 shadow-sm">
                ...
                <p className="text-slate-800">
                  Writing prompts, blogging, poster design, reels, and
                  storytelling activities that help you express ideas clearly
                  and creatively.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-amber-200 bg-amber-50 px-5 py-5 shadow-sm">
                ...
                <p className="text-slate-800">
                  Group discussions, debates, quizzes with explanation rounds,
                  and peer feedback sessions to improve articulation and public
                  speaking.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 items-start">
              ...
              <div className="space-y-4">
                ...
                <ul className="text-sm sm:text-base text-slate-800 space-y-2.5 list-disc pl-6">
                  <li>
                    Participate in interactive quizzes covering general
                    knowledge, current affairs, and theme-based topics.
                  </li>
                  <li>
                  ...
                  <li>
                    Engage in creative activities such as writing prompts,
                    blogging, poster design, and content creation challenges.
                  </li>
                  <li>
                    Collaborate in team-based activities that encourage
                    brainstorming, communication, and creative problem-solving.
                  </li>
                  <li>
                    Build confidence in expressing ideas, presenting viewpoints,
                    and speaking in front of peers in a supportive environment.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-3xl bg-sky-50/80 border border-purple-100 px-6 sm:px-7 py-6 sm:py-7 space-y-5 shadow-sm">
                ...
                <p className="text-sm text-slate-700">
                  Mindblogger is for students who enjoy learning, questioning,
                  and expressing ideas while growing their knowledge and
                ...
                <div className="grid gap-4 md:grid-cols-2 text-sm">
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Love quizzes, current affairs, general knowledge, or
                      testing how quickly you can think and respond under
                      pressure.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Interested in writing, storytelling, content creation,
                      posters, or expressing ideas in creative and engaging
                      ways.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Want to improve speaking, discussions, debates, and
                      presenting your thoughts clearly in front of others.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 border-t border-slate-200 pt-4">
                  ...
                  If you are curious, willing to participate, and open to
                  learning, Mindblogger is the right place to grow together.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="order-1 lg:order-2 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-xs sm:text-sm">
                <div className="rounded-2xl bg-white border border-sky-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Interactive quizzes on general knowledge, current affairs,
                    and themed topics designed to improve thinking speed and
                    clarity.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-purple-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Writing prompts, storytelling tasks, poster ideas, and
                    creative challenges that encourage expression and
                    originality.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-emerald-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Open discussions and explanation rounds where participants
                    share viewpoints, justify answers, and learn from each
                    other.
                  </p>
                </div>
          ...
          <section className="rounded-3xl bg-gradient-to-r from-orange-400 via-purple-500 to-sky-500 border border-purple-300/60 px-5 sm:px-8 py-7 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-md">
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-xs sm:text-sm text-sky-50 max-w-xl mx-auto md:mx-0">
                Fill the interest form, join our next session, and start
                engaging with ideas through quizzes, discussions, and creative
                activities. Your journey begins with curiosity and
                participation.
              </p>
            </div>
