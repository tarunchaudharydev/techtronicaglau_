          ...
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div className="space-y-5 text-center lg:text-left flex flex-col items-center lg:items-start animate-fadeInUp">
              ...
              <ul className="text-xs sm:text-sm text-slate-700 space-y-1.5 max-w-xl text-left">
                <li>
                  • Regular cultural practices, activities, and interactive
                  sessions.
                </li>
                <li>
                  • Opportunities to explore dance, music, drama, anchoring, and
                  creative expression.
                </li>
                <li>
                  • A supportive and friendly space to build confidence,
            ...
            <div className="space-y-5">
              <div className="space-y-3 text-center lg:text-left">
                ...
                <p className="text-sm text-slate-700">
                  With a mix of guided practices, interactive activities, and
                  live performances, the club helps you build confidence,
                  express yourself freely, and grow through real cultural
                  experiences.
                </p>
              </div>
          ...
          <section className="space-y-5">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm sm:text-base text-slate-800 max-w-3xl mx-auto">
                Choose a track that matches your interests and explore more as
                you grow. Seniors and coordinators help you discover where you
                shine best.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3 text-xs sm:text-sm">
              <div className="rounded-3xl border border-sky-200 bg-sky-50 px-4 py-4 shadow-sm">
                ...
                <p className="text-slate-800">
                  Explore dance, music, drama, anchoring, and creative
                  performances—perfect for students who enjoy expressing
                  themselves on stage.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-purple-200 bg-purple-50 px-4 py-4 shadow-sm">
                ...
                <p className="text-slate-800">
                  Focus on communication skills, confidence building, teamwork,
                  and public speaking through interactive activities and
                  sessions.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-amber-200 bg-amber-50 px-4 py-4 shadow-sm">
                ...
                <p className="text-slate-800">
                  Learn event planning, coordination, stage management, and
                  leadership by organizing cultural events and college
                  activities.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 items-start">
              ...
              <div className="space-y-4">
                ...
                <ul className="text-sm sm:text-base text-slate-800 space-y-2.5 list-disc pl-6">
                  ...
                  <li>
                    Take part in dance, music, drama, anchoring, and other
                    creative activities.
                  </li>
                  <li>
                    Build confidence through stage exposure, performances, and
                    group activities.
                  </li>
                  <li>
                    Work in teams to plan, rehearse, and execute cultural
                    programs and events.
                  </li>
                  <li>
              ...
              <div className="rounded-3xl bg-sky-50/80 border border-orange-100 px-6 sm:px-7 py-6 sm:py-7 space-y-5 shadow-sm">
                ...
                <div className="grid gap-4 md:grid-cols-2 text-sm">
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Enjoy dance, music, drama, anchoring, or any form of
                      artistic expression.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Like working with others, rehearsing together, and
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Interested in planning, managing, and executing cultural
                      events and fests.
                    </p>
                  </div>
                </div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 border-t border-slate-200 pt-4">
                  ...
                  All you need is enthusiasm, openness to learn, and the
                  confidence to try.
                </p>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-xs sm:text-sm">
                <div className="rounded-2xl bg-white border border-sky-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Coordinators guide rehearsals, activities, and creative
                    practices to help members gain confidence and improve
                    performance.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-amber-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Seniors and mentors provide constructive feedback to help
                    members grow in confidence, expression, and presentation.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="rounded-3xl bg-gradient-to-r from-orange-400 via-purple-500 to-sky-500 border border-purple-300/60 px-5 sm:px-8 py-7 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-md">
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-xs sm:text-sm text-sky-50 max-w-xl mx-auto md:mx-0">
                ...
                &quot;I&apos;m scared of culture&quot; to &quot;I build cool
                things with culture&quot;. Your first step is simply showing up.
              </p>
            </div>
