          ...
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div className="space-y-5 text-center lg:text-left flex flex-col items-center lg:items-start animate-fadeInUp">
              <span className="text-xs uppercase tracking-[0.25em] text-sky-600">
                Techtronica society • Technovation Club
              </span>
              ...
              <ul className="text-xs sm:text-sm text-slate-700 space-y-1.5 max-w-xl text-left">
                <li>
                  • Hands-on electronics sessions guided by seniors and mentors.
                </li>
                <li>
                  • Learning tracks covering hardware basics, embedded systems,
                  and design tools.
                </li>
                <li>
                  • A practical, collaborative space to experiment, build, and
            ...
            <div className="space-y-5">
              <div className="space-y-3 text-center lg:text-left">
                ...
                <p className="text-sm text-slate-700">
                  With a mix of guided workshops, hands-on practice, and
                  collaborative projects, the club helps you apply theory to
                  real hardware builds and practical engineering solutions.
                </p>
              </div>
          ...
          <section className="space-y-5">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm sm:text-base text-slate-800 max-w-3xl mx-auto">
                ...
                can explore multiple tracks and progress as they build
                confidence.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3 text-xs sm:text-sm">
              ...
              <div className="rounded-3xl border border-sky-200 bg-sky-50 px-4 py-4 shadow-sm">
                ...
                <p className="text-slate-800">
                  Basic electronics concepts, components, breadboarding,
                  sensors, and simple circuit building—ideal for beginners.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-purple-200 bg-purple-50 px-4 py-4 shadow-sm">
                ...
                <p className="text-slate-800">
                  Hands-on work with Arduino, microcontrollers, simulation
                  tools, and design software to understand embedded systems in
                  practice.
                </p>
              </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 items-start">
              ...
              <div className="space-y-4">
                ...
                <ul className="text-sm sm:text-base text-slate-800 space-y-2.5 list-disc pl-6">
                  <li>
                    Work hands-on with electronic components, circuits, sensors,
                    and development boards during guided lab sessions.
                  </li>
                  <li>
                    Learn to use industry-relevant tools such as Arduino,
                    simulation software, and circuit design platforms.
                  </li>
                  <li>
                    Build mini-projects and prototypes individually and in teams
                    to apply theoretical concepts.
                  </li>
                  <li>
                    Participate in workshops focused on embedded systems,
                    hardware debugging, and system design.
                  </li>
                  <li>
                    Develop problem-solving skills by troubleshooting real
                    hardware issues and improving existing designs.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-3xl bg-sky-50/80 border border-purple-100 px-6 sm:px-7 py-6 sm:py-7 space-y-5 shadow-sm">
                ...
                <div className="grid gap-4 md:grid-cols-2 text-sm">
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      New to hardware or lab work and looking for structured
                      guidance, practical exposure, and supportive peers.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Interested in learning Arduino, simulation tools, circuit
                      design software, and embedded platforms hands-on.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Want to convert ideas into working prototypes, lab
                      projects, or real-world electronic solutions.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-700">
                      Preparing for core electronics roles and aiming to build
                ...
                <p className="text-xs sm:text-sm text-slate-600 border-t border-slate-200 pt-4">
                  ...
                  Curiosity, willingness to learn, and consistency are all you
                  need to grow with Technovation.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="order-1 lg:order-2 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-xs sm:text-sm">
                <div className="rounded-2xl bg-white border border-sky-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Seniors demonstrate circuits, components, and tools step by
                    step, followed by hands-on practice.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-white border border-purple-100 px-4 py-4 shadow-sm">
                  ...
                  <p className="text-slate-800">
                    Practical workshops on Arduino, simulation software, and
                    circuit design platforms.
                  </p>
                </div>
          ...
          <section className="rounded-3xl bg-gradient-to-r from-orange-400 via-purple-500 to-sky-500 border border-purple-300/60 px-5 sm:px-8 py-7 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-md">
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-xs sm:text-sm text-sky-50 max-w-xl mx-auto md:mx-0">
                Fill the interest form, join our next lab session, and start
                turning electronic concepts into real circuits and working
                prototypes. Your first step is simply showing up and building.
              </p>
            </div>
