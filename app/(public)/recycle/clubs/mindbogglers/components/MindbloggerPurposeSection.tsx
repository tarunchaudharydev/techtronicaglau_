...
export function MindbloggerPurposeSection({ aboutMindblogger }: Props) {
  return (
      ...
      <div className="space-y-5">
        <div className="space-y-3 text-center lg:text-left">
          ...
          <div className="space-y-3">
            {aboutMindblogger.purposeDescription.map((text, i) => (
              <p
                key={i}
          ...
          <p className="text-sm text-slate-700">
            ...
            discussions, and self-practice, the club helps you sharpen your
            thinking, express ideas clearly, and build confidence in
            communication.
          </p>
        </div>
