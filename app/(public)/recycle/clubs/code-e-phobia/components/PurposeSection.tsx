    ...
    <section className="grid gap-10 lg:grid-cols-[1.5fr,1.1fr] items-center">
      ...
      <div className="space-y-5">
        <div className="space-y-3 text-center lg:text-left">
          ...
          <div className="text-sm sm:text-base text-slate-800 leading-relaxed space-y-3">
            {aboutCodeEPhobia.purposeDescription.map((desc, index) => (
              <p key={index}>{desc}</p>
            ))}
          </div>
          <p className="text-sm text-slate-700">
            With a mix of guided sessions, self‑practice time, and mock
            contests, the club helps you stay consistent and turn theory into
      ...
      <div className="relative h-44 sm:h-56 md:h-64 w-full">
        ...
        <div className="relative h-full w-full overflow-hidden rounded-3xl border border-slate-200 shadow-md bg-white">
          <Image
            src="/clubs/code-e-phobia/images/Hackthon.jpg"
            alt="Hackthon"
            width={800}
            height={450}
