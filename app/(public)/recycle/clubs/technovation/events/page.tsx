...
export default function TechnovationEvents() {
  ...
  const technovationEvents = events.filter((e) => e.club === "Technovation");

  const upcomingEvents = technovationEvents.filter((e) => {
    if (!e.registrationDeadline) return false;
    return getISTDeadline(e.registrationDeadline) > getISTNow();
  });

  const pastEvents = technovationEvents.filter((e) => {
      ...
      <div className="max-w-6xl mx-auto space-y-20">
        ...
        <header className="text-center space-y-3">
          ...
          <p className="text-slate-700 max-w-2xl mx-auto">
            Upcoming and completed events organized by Technovation.
          </p>
        </header>
