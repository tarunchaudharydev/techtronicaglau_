...
export function TechnovationPurposeSection({ aboutTechnovation }: Props) {
  return (
      ...
      <div className="space-y-5">
        <div className="space-y-3 text-center lg:text-left">
          ...
          <div className="space-y-3">
            {aboutTechnovation.purposeDescription.map((text, i) => (
              <p
                key={i}
          ...
          <p className="text-sm text-slate-700">
            With a mix of guided workshops, hands-on practice, and collaborative
            projects, the club helps you apply theory to real hardware builds
