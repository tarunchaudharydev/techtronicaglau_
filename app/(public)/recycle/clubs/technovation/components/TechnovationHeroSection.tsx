...
interface Props {
  aboutTechnovation: AboutClub;
}

export function TechnovationHeroSection({ aboutTechnovation }: Props) {
  return (
      ...
      <div className="grid gap-10 lg:grid-cols-2 items-center">
        ...
        <div className="space-y-5 text-center lg:text-left flex flex-col items-center lg:items-start animate-fadeInUp">
          ...
          <div className="space-y-3 max-w-xl mt-3 mb-2 text-center lg:text-left">
            {aboutTechnovation.description.map((text, i) => (
          ...
          <ul className="text-xs sm:text-sm text-slate-700 space-y-1.5 max-w-xl text-left">
            ...
            <li>
              • Learning tracks covering hardware basics, embedded systems, and
              design tools.
            </li>
            <li>
              • A practical, collaborative space to experiment, build, and solve
              real-world problems.
            </li>
          </ul>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-3 pt-2">
            ...
            <Link
              href="/clubs/technovation/events"
        ...
        <div className="relative mt-6 lg:mt-0 animate-fadeInRight">
          ...
          <div className="rounded-3xl bg-white border border-purple-100 shadow-xl overflow-hidden">
            <Image
              ...
              alt="Students working on hardware projects in Technovation"
              width={800}
              height={450}
