...
export default function UnnatiEvents() {
  ...
  const unnatiEvents = events.filter((e) => e.club === "Unnati");

  const upcomingEvents = unnatiEvents.filter((e) => {
    if (!e.registrationDeadline) return false;
    return getISTDeadline(e.registrationDeadline) > getISTNow();
  });

  const pastEvents = unnatiEvents.filter((e) => {
      ...
      <div className="max-w-6xl mx-auto space-y-20">
        ...
        <header className="text-center space-y-3">
          ...
          <p className="text-slate-700 max-w-2xl mx-auto">
            Upcoming and completed events organized by Unnati.
          </p>
        </header>
