...
interface Props {
  aboutUnnati: AboutClub;
}

export function UnnatiHeroSection({ aboutUnnati }: Props) {
  return (
        ...
        <div className="space-y-5 text-center lg:text-left flex flex-col items-center lg:items-start animate-fadeInUp">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">
              <span className="block text-slate-900">{aboutUnnati.title}</span>
          ...
          <div className="space-y-3 max-w-xl mt-3 mb-2 text-center lg:text-left">
            {aboutUnnati.description.map((text, i) => (
          ...
          <ul className="text-xs sm:text-sm text-slate-700 space-y-1.5 max-w-xl text-left">
            ...
            <li>
              • A supportive and friendly space to build confidence, teamwork,
              and stage presence.
            </li>
          </ul>
