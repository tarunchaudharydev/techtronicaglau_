...
export function UnnatiPurposeSection({ aboutUnnati }: Props) {
  return (
      ...
      <div className="space-y-5">
        <div className="space-y-3 text-center lg:text-left">
          ...
          <div className="space-y-3">
            {aboutUnnati.purposeDescription.map((text, i) => (
              <p
                key={i}
          ...
          <p className="text-sm text-slate-700">
            With a mix of guided practices, interactive activities, and live
            performances, the club helps you build confidence, express yourself
            freely, and grow through real cultural experiences.
          </p>
        </div>
      ...
      <div className="relative h-44 sm:h-56 md:h-64 w-full">
        ...
        <div className="relative h-full w-full overflow-hidden rounded-3xl border border-slate-200 shadow-md bg-white">
          <Image
            ...
            alt="Team celebration in Unnati"
            width={800}
            height={450}
