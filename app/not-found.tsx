...
export default function NotFound() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-sky-50 to-amber-50 px-4">
      <div className="w-full max-w-xl rounded-3xl border border-purple-200 bg-white/90 px-6 py-8 shadow-[0_25px_80px_rgba(15,23,42,0.15)] backdrop-blur-xl text-center">
        {/* Error Animation */}
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <Link
            href="/clubs"
            className="rounded-full border border-purple-200 bg-white px-6 py-2.5 text-sm font-semibold text-purple-800 transition hover:bg-purple-50 hover:-translate-y-0.5"
          >
            Explore Clubs
          </Link>
          ...
          <Link
            href="/events"
            className="rounded-full border border-sky-200 bg-white px-6 py-2.5 text-sm font-semibold text-sky-800 transition hover:bg-sky-50 hover:-translate-y-0.5"
          >
            Explore Events
          </Link>
          ...
          <Link
            href="/academics"
            className="rounded-full border border-amber-200 bg-white px-6 py-2.5 text-sm font-semibold text-amber-800 transition hover:bg-amber-50 hover:-translate-y-0.5"
          >
            Explore Academics
          </Link>
        </div>
