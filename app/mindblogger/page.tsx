...
import { aboutMindblogger } from "../data/home-data";
...
function MindBlogger() {
          ...
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div className="space-y-5 text-center lg:text-left flex flex-col items-center lg:items-start animate-fadeInUp">
              ...
              <ul className="text-xs sm:text-sm text-slate-700 space-y-1.5 max-w-xl text-left">
                ...
                <li>• A low‑pressure, friendly space to ask doubts and grow together.</li>
              </ul>
          ...
          <section className="grid gap-10 lg:grid-cols-[1.5fr,1.1fr] items-center">
            ...
            <div className="space-y-5">
              <div className="space-y-3 text-center lg:text-left">
                <h2 className="text-xl sm:text-2xl font-bold text-purple-800">
                  {aboutMindblogger.purpose}
                </h2>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed">
                  {aboutMindblogger.purposeDescription}
                </p>
                <p className="text-sm text-slate-700">
                  With a mix of interactive quizzes, creative challenges, guided discussions, and self-practice, the club helps you sharpen your thinking, express ideas clearly, and build confidence in communication.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    {
                      label: "Sessions",
                      value: "Weekly meetups",
                      color: "text-purple-700",
                    },
                    {
                      label: "Level",
                      value: "All backgrounds",
                      color: "text-orange-600",
                    },
                  ].map((item) => (
                    <div
            ...
            <div className="relative h-44 sm:h-56 md:h-64 w-full">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-3xl border border-slate-200 shadow-md bg-white">
                <Image
                  src="/images/mindblogger/team-discussion.jpg"
                  alt="Team discussion in MindBlogger"
                  width={800}
                  height={450}
  ...
  <div className="text-center space-y-2">
    ...
    <p className="text-sm sm:text-base text-slate-800 max-w-3xl mx-auto">
      Explore different tracks focused on quizzes, creativity, and communication.
      Members are free to switch tracks as they discover their interests.
    </p>
  </div>

  {/* Tracks Grid */}
  <div className="grid gap-6 md:grid-cols-3 text-sm">
    {/* Beginner / Knowledge Track */}
    <div className="rounded-3xl border border-sky-200 bg-sky-50 px-5 py-5 shadow-sm">
      ...
      <p className="text-slate-800">
        General knowledge, current affairs, logical reasoning, and themed quizzes
        designed to build awareness, speed, and confidence.
      </p>
    </div>
    ...
    <div className="rounded-3xl border border-amber-200 bg-amber-50 px-5 py-5 shadow-sm">
      ...
      <p className="text-slate-800">
        Group discussions, debates, quizzes with explanation rounds, and peer
        feedback sessions to improve articulation and public speaking.
      </p>
    </div>
  </div>
</section>
  ...
  <ul className="text-sm sm:text-base text-slate-800 space-y-2.5 list-disc pl-6">
    <li>
      Participate in interactive quizzes covering general knowledge, current
      affairs, and theme-based topics.
    </li>
    <li>
      Take part in group discussions, explanation rounds, and idea-sharing
      sessions to strengthen clarity of thought.
    </li>
    <li>
      Engage in creative activities such as writing prompts, blogging, poster
      design, and content creation challenges.
    </li>
    <li>
    ...
    <li>
      Build confidence in expressing ideas, presenting viewpoints, and speaking
      in front of peers in a supportive environment.
    </li>
  </ul>
</div>
...
<div className="rounded-3xl bg-sky-50/80 border border-purple-100 px-6 sm:px-7 py-6 sm:py-7 space-y-5 shadow-sm">
  ...
  <p className="text-sm text-slate-700">
    Mindblogger is for students who enjoy learning, questioning, and expressing
    ideas while growing their knowledge and communication skills.
  </p>
  ...
  <div className="grid gap-4 md:grid-cols-2 text-sm">
    <div className="space-y-1">
      ...
      <p className="text-slate-700">
        Love quizzes, current affairs, general knowledge, or testing how quickly
        you can think and respond under pressure.
      </p>
    </div>
    ...
    <div className="space-y-1">
      ...
      <p className="text-slate-700">
        Enjoy exploring new topics, asking questions, and learning beyond
        textbooks through interactive activities.
      </p>
    </div>
    ...
    <div className="space-y-1">
      ...
      <p className="text-slate-700">
        Interested in writing, storytelling, content creation, posters, or
        expressing ideas in creative and engaging ways.
      </p>
    </div>
    ...
    <div className="space-y-1">
      ...
      <p className="text-slate-700">
        Want to improve speaking, discussions, debates, and presenting your
        thoughts clearly in front of others.
      </p>
    </div>
  </div>
  ...
  <p className="text-xs sm:text-sm text-slate-600 border-t border-slate-200 pt-4">
    ...
    If you are curious, willing to participate, and open to learning, Mindblogger
    is the right place to grow together.
  </p>
</div>
  ...
  <div className="order-1 lg:order-2 space-y-4">
    ...
    <div className="grid gap-4 sm:grid-cols-2 text-xs sm:text-sm">
      <div className="rounded-2xl bg-white border border-sky-100 px-4 py-4 shadow-sm">
        ...
        <p className="text-slate-800">
          Interactive quizzes on general knowledge, current affairs, and themed
          topics designed to improve thinking speed and clarity.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-amber-100 px-4 py-4 shadow-sm">
        ...
        <p className="text-slate-800">
          Seniors and peers provide constructive feedback to help you improve
          confidence, communication, and clarity of thought.
        </p>
      </div>
    </div>
  </div>
  ...
  <h2 className="text-base sm:text-lg font-semibold text-white">
    Ready to explore, learn, and express?
  </h2>
  <p className="text-xs sm:text-sm text-sky-50 max-w-xl mx-auto md:mx-0">
    Fill the interest form, join our next session, and start engaging with ideas
    through quizzes, discussions, and creative activities. Your journey begins
    with curiosity and participation.
  </p>
</div>
