...
import { aboutUnnati } from "../data/home-data";
...
function Unnati() {
          ...
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            ...
            <div className="space-y-5 text-center lg:text-left flex flex-col items-center lg:items-start animate-fadeInUp">
              ...
              <p className="text-sm sm:text-base text-slate-800 max-w-xl mt-3 mb-2 text-center lg:text-left">
                {aboutUnnati.description}
              </p>

              <ul className="text-xs sm:text-sm text-slate-700 space-y-1.5 max-w-xl text-left">
                <li>• Regular cultural practices, activities, and interactive sessions.</li>
                <li>• Opportunities to explore dance, music, drama, anchoring, and creative expression.</li>
                <li>• A supportive and friendly space to build confidence, teamwork, and stage presence.</li>
              </ul>
            ...
            <div className="relative mt-6 lg:mt-0 animate-fadeInRight">
              ...
              <div className="rounded-3xl bg-white border border-purple-100 shadow-xl overflow-hidden">
                <div className="w-full">
                  <Image
                    src="/images/unnati/diwali.jpg"
                    alt="Students celebrating Diwali in Unnati"
                    width={800}
                    height={450}
  ...
  Live performances, real expression.
</p>
<p className="text-orange-500 font-medium text-right">
  🎭 Culture • 🎤 Confidence • 🤝 Community
</p>
            ...
            <div className="space-y-5">
              <div className="space-y-3 text-center lg:text-left">
                ...
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed">
                  {aboutUnnati.purposeDescription}
                </p>
                <p className="text-sm text-slate-700">
  With a mix of guided practices, interactive activities, and live performances,
  the club helps you build confidence, express yourself freely, and grow through
  ...
  {[
    {
      label: "Focus",
      value: "Culture • Expression • Personality",
    ...
    {
      label: "Sessions",
      value: "Cultural activities & practice sessions",
      color: "text-purple-700",
    },
    {
      label: "Level",
      value: "Beginner-friendly to experienced",
      color: "text-orange-600",
    },
  ].map((item) => (
    <div
        ...
        {item.value}
            ...
            <div className="relative h-44 sm:h-56 md:h-64 w-full">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-3xl border border-slate-200 shadow-md bg-white">
                <Image
                  src="/images/unnati/conguralation.jpg"
                  alt="Team discussion in Unnati"
                  width={800}
                  height={450}
  ...
  <div className="text-center space-y-2">
    ...
    <p className="text-sm sm:text-base text-slate-800 max-w-3xl mx-auto">
      Choose a track that matches your interests and explore more as you grow.
      Seniors and coordinators help you discover where you shine best.
    </p>
  </div>
  ...
  <div className="grid gap-6 md:grid-cols-3 text-xs sm:text-sm">
    <div className="rounded-3xl border border-sky-200 bg-sky-50 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Explore dance, music, drama, anchoring, and creative performances—perfect
        for students who enjoy expressing themselves on stage.
      </p>
    </div>
    ...
    <div className="rounded-3xl border border-purple-200 bg-purple-50 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Focus on communication skills, confidence building, teamwork, and public
        speaking through interactive activities and sessions.
      </p>
    </div>
    ...
    <div className="rounded-3xl border border-amber-200 bg-amber-50 px-4 py-4 shadow-sm">
      ...
      <p className="text-slate-800">
        Learn event planning, coordination, stage management, and leadership by
        organizing cultural events and college activities.
      </p>
    </div>
  </div>
</section>
  ...
  <div className="grid gap-8 lg:grid-cols-2 items-start">
    ...
    <div className="space-y-4">
      ...
      <ul className="text-sm sm:text-base text-slate-800 space-y-2.5 list-disc pl-6">
        <li>Participate in cultural events, competitions, and campus celebrations.</li>
        <li>
          Take part in dance, music, drama, anchoring, and other creative activities.
        </li>
        <li>
          Build confidence through stage exposure, performances, and group activities.
        </li>
        <li>
          Work in teams to plan, rehearse, and execute cultural programs and events.
        </li>
        <li>
          Develop communication, leadership, and interpersonal skills naturally.
        </li>
      </ul>
    </div>
    ...
    <div className="rounded-3xl bg-sky-50/80 border border-orange-100 px-6 sm:px-7 py-6 sm:py-7 space-y-5 shadow-sm">
      ...
      <p className="text-sm text-slate-700">
        Unnati is for students who want to express themselves, build confidence,
        and grow beyond academics in a supportive cultural environment.
      </p>

      <div className="grid gap-4 md:grid-cols-2 text-sm">
        <div className="space-y-1">
          <p className="font-semibold text-slate-900">Creative enthusiasts</p>
          <p className="text-slate-700">
            Enjoy dance, music, drama, anchoring, or any form of artistic expression.
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            Want to improve stage presence, communication skills, and self-confidence.
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            Like working with others, rehearsing together, and supporting group efforts.
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-700">
            Interested in planning, managing, and executing cultural events and fests.
          </p>
        </div>
      </div>

      <p className="text-xs sm:text-sm text-slate-600 border-t border-slate-200 pt-4">
        <span className="font-semibold text-slate-800">No prior experience needed.</span>{" "}
        All you need is enthusiasm, openness to learn, and the confidence to try.
      </p>
    </div>
  </div>
</section>
  ...
  <div className="order-1 lg:order-2 space-y-4">
    ...
    <div className="grid gap-4 sm:grid-cols-2 text-xs sm:text-sm">
      <div className="rounded-2xl bg-white border border-sky-100 px-4 py-4 shadow-sm">
        ...
        <p className="text-slate-800">
          Coordinators guide rehearsals, activities, and creative practices to
          help members gain confidence and improve performance.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-purple-100 px-4 py-4 shadow-sm">
        ...
        <p className="text-slate-800">
          Fun group activities, games, and exercises that improve communication,
          teamwork, and stage comfort.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-emerald-100 px-4 py-4 shadow-sm">
        ...
        <p className="text-slate-800">
          Dedicated rehearsal sessions to prepare performances, skits, dances,
          and anchoring segments for college events.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white border border-amber-100 px-4 py-4 shadow-sm">
        ...
        <p className="text-slate-800">
          Seniors and mentors provide constructive feedback to help members grow
          in confidence, expression, and presentation.
        </p>
      </div>
    </div>
  </div>
          ...
          <section className="rounded-3xl bg-gradient-to-r from-orange-400 via-purple-500 to-sky-500 border border-purple-300/60 px-5 sm:px-8 py-7 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-md">
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-xs sm:text-sm text-sky-50 max-w-xl mx-auto md:mx-0">
                ...
                &quot;I&apos;m scared of culture&quot; to &quot;I build cool things
                with culture&quot;. Your first step is simply showing up.
              </p>
            </div>
